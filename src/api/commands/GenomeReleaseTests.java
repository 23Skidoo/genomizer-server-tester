...
public class GenomeReleaseTests extends TestCollection{
    ...
    public GenomeReleaseTests(){
        ...
        super.commandList.add(new GetSpecificGenomeTest("GET GENOME SINGLE", "Fly", "{\"genomeVersion\":\"SingleFileTest\",\"species\":\"Fly\",\"folderPath\":\"/data/genome_releases/Fly/SingleFileTest/\",\"files\":[\"File.whatever\"]}", true));
        ...
        super.commandList.add(new GetSpecificGenomeTest("GET GENOME MULTI", "Human", "{\"genomeVersion\":\"MultiFileTest\",\"species\":\"Human\",\"folderPath\":\"/data/genome_releases/Human/MultiFileTest/\",\"files\":[\"File1.wha\",\"File2.wha\",\"File3.wha\"]}", true));
